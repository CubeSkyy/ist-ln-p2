...
fstdraw    --isymbols=syms.txt --osymbols=syms.txt --portrait lemma2noun.fst | dot -Tpdf  > FINALpdf/lemma2noun.pdf

#a2
fstcompile --isymbols=syms.txt --osymbols=syms.txt  lemma2adverb.txt | fstarcsort > FINALtransducers/lemma2adverb.fst
fstdraw    --isymbols=syms.txt --osymbols=syms.txt --portrait lemma2adverb.fst | dot -Tpdf  > FINALpdf/lemma2adverb.pdf

#a3
fstcompile --isymbols=syms.txt --osymbols=syms.txt  lemma2verbip.txt | fstarcsort > FINALtransducers/lemma2verbip.fst
fstdraw    --isymbols=syms.txt --osymbols=syms.txt --portrait lemma2verbip.fst | dot -Tpdf  > FINALpdf/lemma2verbip.pdf

#a4
fstcompile --isymbols=syms.txt --osymbols=syms.txt  lemma2verbis.txt | fstarcsort > FINALtransducers/lemma2verbis.fst
fstdraw    --isymbols=syms.txt --osymbols=syms.txt --portrait lemma2verbis.fst | dot -Tpdf  > FINALpdf/lemma2verbis.pdf

#a5
fstcompile --isymbols=syms.txt --osymbols=syms.txt  lemma2verbif.txt | fstarcsort > FINALtransducers/lemma2verbif.fst
fstdraw    --isymbols=syms.txt --osymbols=syms.txt --portrait lemma2verbif.fst | dot -Tpdf  > FINALpdf/lemma2verbif.pdf

#b6
fstunion lemma2verbip.fst lemma2verbis.fst > lemma2verb1.fst
fstunion lemma2verb1.fst lemma2verbif.fst > FINALtransducers/lemma2verb.fst
rm -f lemma2verb1.fst

fstdraw    --isymbols=syms.txt --osymbols=syms.txt --portrait lemma2verb.fst | dot -Tpdf  > FINALpdf/lemma2verb.pdf

#b7
fstunion lemma2noun.fst lemma2adverb.fst > lemma2word1.fst
fstunion lemma2word1.fst lemma2verb.fst > FINALtransducers/lemma2word.fst
rm -f lemma2word1.fst

fstdraw    --isymbols=syms.txt --osymbols=syms.txt --portrait lemma2word.fst | dot -Tpdf  > FINALpdf/lemma2word.pdf

#c8
fstinvert lemma2word.fst > FINALtransducers/word2lemma.fst
fstdraw    --isymbols=syms.txt --osymbols=syms.txt --portrait word2lemma.fst | dot -Tpdf  > FINALpdf/word2lemma.pdf
...
#incrivelmente ADV
fstcompose ../test/a2/incrivelmenteADV.fst lemma2word.fst > ../test/b7/out/incrivelmenteADVb7.fst
fstdraw    --isymbols=syms.txt --osymbols=syms.txt --portrait ../test/b7/out/incrivelmenteADVb7.fst | dot -Tpdf  > ../test/b7/out/incrivelmenteADVb7.pdf
